...
export class Mig1712946502039 implements MigrationInterface {
  name = 'Mig1712946502039';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "meal" ("id" SERIAL NOT NULL, "description" character varying(400) NOT NULL, "date" TIMESTAMP NOT NULL, "calories" integer, "proteins" integer, "carbs" integer, "fats" integer, "userId" integer, CONSTRAINT "PK_ada510a5aba19e6bb500f8f7817" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
